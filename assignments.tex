...
\end{equation*}
we know from \cite[Example 7]{adjacency_matrix}  that the eigenvalues of $C_4$ are given by $\{2cos(\frac{2\pi k}{4}) \mid k \in [0, 3]\} = \{ 2, 0, -2, 0 \}$ each with multiplicity 1.
...
Determine $\sigma(K_n)$ using the fact that the null graph on n-vertices is the complement of $K_4$.
\end{problem}
